...
namespace ThirteenPixels.Soda.Editor
{
    ...
    /// The class comes with a matching ScopedVariable type.
    /// </summary>
    public abstract class TypeCreationWizardBase : EditorWindow
    {
        ...
        private void QueueGeneratingClass()
        {
            var typeName = enteredTypeName;
            EditorApplication.delayCall += () => GenerateClass(typeName);
        }

        private void GenerateClass(string typeName)
        {
