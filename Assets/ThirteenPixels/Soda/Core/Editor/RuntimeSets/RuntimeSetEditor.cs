...
namespace ThirteenPixels.Soda.Editor
{
    ...
    {
        protected virtual string subtitle => $"RuntimeSet ({((RuntimeSetBase)target).itemType.Name})";
        ...
        public override void OnInspectorGUI()
        {
            ...
            var descriptionProperty = serializedObject.FindProperty(RuntimeSetBase.PropertyNames.description);
