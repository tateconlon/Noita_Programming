...
namespace ThirteenPixels.Soda
{
    ...
    /// This comes very close to what is often referred to as a "singleton" in Unity terminology, but without the disadvantages of actual static code.
    /// </summary>
    public abstract class GlobalGameObjectWithComponentCacheBase<T> : GlobalGameObject
    {
        ...
        {
            return TryCreateComponentCache(gameObject, out var result);
        }
