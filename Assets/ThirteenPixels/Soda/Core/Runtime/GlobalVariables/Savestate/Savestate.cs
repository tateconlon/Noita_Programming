...
namespace ThirteenPixels.Soda
{
    ...
    /// </summary>
    [HelpURL(SodaDocumentation.URL_RUNTIME + nameof(Savestate))]
    [SceneBindable(categoryName: "Savestates", isCoreItem: true)]
    [CreateAssetMenu(menuName = "Soda/Savestate", order = 800)]
