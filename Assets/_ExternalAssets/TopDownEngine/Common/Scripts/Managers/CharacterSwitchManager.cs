...
namespace MoreMountains.TopDownEngine
{
	...
	public class CharacterSwitchManager : MonoBehaviour
	{
		...
		protected virtual void SwitchCharacter()
		{
			...
			if (CommonHealth)
			{
				_instantiatedCharacters[CurrentIndex].gameObject.MMGetComponentNoAlloc<FEELHealth>().SetHealth(LevelManager.Instance.Players[0].gameObject.MMGetComponentNoAlloc<FEELHealth>().CurrentHealth);
			}
