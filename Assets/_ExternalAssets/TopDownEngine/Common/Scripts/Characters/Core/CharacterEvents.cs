...
{	
	...
	public struct MMLifeCycleEvent
	{
		...
		public MMLifeCycleEvent(FEELHealth affectedHealth, MMLifeCycleEventTypes lifeCycleEventType)
		{
		...
		public static void Trigger(FEELHealth affectedHealth, MMLifeCycleEventTypes lifeCycleEventType)
		{
