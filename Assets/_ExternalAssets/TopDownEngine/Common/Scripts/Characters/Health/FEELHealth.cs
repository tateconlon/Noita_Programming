...
namespace MoreMountains.TopDownEngine
{
	...
	{
		public FEELHealth AffectedHealth;
		public float NewHealth;
		
		public HealthChangeEvent(FEELHealth affectedHealth, float newHealth)
		{
		...
		public static void Trigger(FEELHealth affectedHealth, float newHealth)
		{
	...
	public class FEELHealth : MMMonoBehaviour
	{
		...
		public FEELHealth MasterHealth;
		...
		public virtual void Initialization()
		{
			...
			if (_healthBar == null)
			{
				...
				if (_healthBar == null)
				{
					_healthBar = this.gameObject.GetComponentInChildren<MMHealthBar>();
				}
			}
		...
		public virtual void Damage(float damage, GameObject instigator, float flickerDuration, float invincibilityDuration, Vector3 damageDirection, List<TypedDamage> typedDamages = null)
		{
			...
			// // ASSETMOD
			// E.Skills.OnHit.Raise(new E.Skills.HitParams
			// {
			// 	Attacker = instigator.GetComponent<Minion>(),
			// 	Victim = this,
			// 	Damage = damage,
			// 	CriticalHit = false
			// });
			...
			else
			{
				if (CurrentHealth <= 0)
				{
					...
					// // ASSETMOD
					// E.Skills.OnKill.Raise(new E.Skills.KillParams
					// {
					// 	Attacker = instigator.GetComponent<Minion>(),
					// 	Victim = this,
					// 	Damage = damage,
		...
		public virtual void Kill()
		{
			...
			UbhBullet bullet = GetComponentInParent<UbhBullet>();
			if (bullet)
			{
