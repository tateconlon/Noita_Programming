...
public abstract class UbhBaseShot : UbhMonoBehaviour
{
    ...
    public event Action<UbhBullet> OnBulletSpawned;
    ...
    protected UbhBullet GetBullet(Vector3 position, bool forceInstantiate = false)
    {
        ...
        UbhBullet newBullet = UbhObjectPool.instance.GetBullet(m_bulletPrefab, position, forceInstantiate);
        
        OnBulletSpawned?.Invoke(newBullet);
