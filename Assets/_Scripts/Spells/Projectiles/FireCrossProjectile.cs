...
public class FireCrossProjectile : MonoBehaviour
{
    ...
    private IEnumerator PeriodicTriggerCR()
    {
        ...
        {
            yield return new WaitForSeconds(triggerTimer);  // This could scale with speed or some other stat
    ...
    public class TimerEventData
    {
        ...
        public FireCrossProjectile projectile;
    }
}